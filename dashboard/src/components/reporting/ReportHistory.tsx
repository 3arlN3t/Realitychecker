...
// Helper component for the grid layout in the details dialog
const Grid = ({ container, item, xs, sm, spacing, children }: any) => {
  if (container) {
    return (
      <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: spacing * 8, mt: 2 }}>
        {children}
      </Box>
    );
  }
